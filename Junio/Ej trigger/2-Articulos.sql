...
INSERT INTO VENTAS VALUES(2, 5, SYSDATE); --VENTA CORRECTA
...
AFTER INSERT OR UPDATE OF SALARIO, NUM_DEP ON EMPLEADO
FOR EACH ROW
BEGIN
	UPDATE DEPARTAMENTO SET PRESUPUESTO = PRESUPUESTO - :OLD.SALARIO WHERE NUM_DEP = :OLD.NUM_DEP;
    UPDATE DEPARTAMENTO SET PRESUPUESTO = PRESUPUESTO + :NEW.SALARIO WHERE NUM_DEP = :NEW.NUM_DEP;
END PRESUPUESTO_DEPT;

--COMPROBAR
INSERT INTO DEPARTAMENTO VALUES(1, 'VENTAS', 100);
INSERT INTO EMPLEADO VALUES(123, 'PEPE', 200, 1);
UPDATE EMPLEADO SET SALARIO = 300 WHERE NSS = 123;
INSERT INTO DEPARTAMENTO VALUES(2, 'GESTIÓN', 0);
UPDATE EMPLEADO SET NUM_DEP = 2 WHERE NSS = 123;
