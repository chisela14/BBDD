...
--upper para practicar que sea indiferente en mayuscula
...
SELECT T.NOMBRE FROM TITULACION T, ASIGNATURA ASIG 
WHERE T.IDTITULACION = ASIG.IDTITULACION 
AND ASIG.CREDITOS = 4;
...
--AND ASIG.IDASIGNATURA IS NOT NULL; no haria falta
